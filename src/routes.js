...
const billingList  = React.lazy(() => import('./views/billings/billingList'))
const productList  = React.lazy(() => import('./views/products/productList'))
const parentProduct  = React.lazy(() => import('./views/master_products/masterproductList'))
...
const routes = [
  ...
  { path: '/customerList', name: 'Customer', element: customerList },
  { path: '/companyList', name: 'Company', element: companyList },
  { path: '/userList', name: 'User', element: userList },
  { path: '/billingList', name: 'Billings', element: billingList },
  { path: '/productList', name: 'Products', element: productList },
  { path: '/billingCreation', name: 'Billings', element: BillingCreation },
